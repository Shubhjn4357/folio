      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div
            ...
            } p-6 bg-gradient-to-r from-red-900 to-black-100  w-screen origin-right absolute transition duration-500 ease-in-out top-0 right-0 h-screen z-10 rounded-xl`}
          >
