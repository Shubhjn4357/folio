    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "shubhamjain.com.in@gmai.com",
    ...
    >
      ...
      >
        <div className='flex justify-between'>
          ...
          <div>
            <a className=' text-[20px] sm:text-[10px] text-white-300' href='https://drive.google.com/file/d/1bij11HuUXkNLiFN8QxMhjz_UREjkoFU_/view?usp=drive_link'>
